...
exports.deleteReply = exports.editReply = exports.replieToComment = void 0;
...
// add comment
const replieToComment = (0, catchErrors_1.catchError)(async (req, res, next) => {
    let addReplie = await repliesModel_1.Replie.create({
...
exports.replieToComment = replieToComment;
const editReply = (0, catchErrors_1.catchError)(async (req, res, next) => {
    let reply = await repliesModel_1.Replie.findById(req.params.id);
    if (!reply)
